         ...
         <div class="page-sidebar sidebar">
            ...
            <div class="page-inner">
                <div class="page-title" style="margin-bottom: 0px;">
                    <h3><b>Update Domestic Import Entry</b></h3>
          ...
          <%
        String domestic_id=request.getParameter("id");
        String pn="";
        String sb="";
        String payment="";
        %>
                                    <form action="NewEditServlet_2" method="Post">
                                        <div class="form-group">
                                            <label for="domesticid">Domestic ID</label><br>
                                            <input type="text" value="<%out.print(domestic_id);%>" name="domesticid" class="form-control" id="importid" hidden>
                                        </div>
                                        <div class="form-group">
                                       ...
                                       <select id="material-input" name="material" class="form-control" placeholder="Material Name" style="color: #a4a4a4" required>
                                                                ...
                                                                try
                                                            {
                                                             ...
                                                             String query="select * from domestic where domestic_id='"+domestic_id+"'";
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="party_name" value="<%out.print(pn);%>">
                                        </div>
                                         <div class="form-group">
                                            <label>Sold By</label>
                                       
                                            <input type="text" class="form-control" name="sold_by" value="<%out.print(sb);%>" >
                                        </div>
                                        <div class="form-group">
                                            <label>Payment</label>
                                       
                                            <input type="text" class="form-control" name="payment" value="<%out.print(payment);%>" >
                                        </div>
<!--                                         <div class="form-group">
                                            <label >Rate</label>
