                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="home.html">Transfer</a></li>
                        </ol>
                    </div>
                </div>
    ...
    <div  style="width:90%; margin:auto;">
                ...
                <table class="table table-bordered table-striped table-hover table-condensed  text-center" id="editableTable"  style="text-align: center;">
                    <thead style="border: 1px solid black;">
                        <tr style="border: 1px solid black;">
                            <th class="text-center" style="border: 1px solid black;">From</th>
                            <th class="text-center" style="border: 1px solid black;">Material Name</th>
                            <th class="text-center" style="border: 1px solid black;">To</th>
     ...
     %>               
                    ...
                    <tbody style="border: 1px solid black;">
                        <tr data-id="1">
                            <td data-field="name" style="border: 1px solid black;"><%out.print(rs.getString("from"));%></td>
                            <td data-field="birthday" style="border: 1px solid black;"><%out.print(rs.getString("material_name"));%></td>
                            <td data-field="age" style="border: 1px solid black;"><%out.print(rs.getString("to"));%></td>
                            <td data-field="name" style="border: 1px solid black;"><%out.print(rs.getString("Quantity"));%></td>
...
<!--Pop-up Modal-->
  ...
  <form action="TransferCheckerServlet" method="Post">
      ...
      <span class="row" style="float:left; margin-left:100px; width:500px; ">
      <span class="col-25">
        <label style="margin-left:-70%; " for="pname">From:</label>
      </span>
      <span class="col-75" style="width:345px;">
        <input  style="margin-left:-125px; margin-right:50px;  width:238px; "  type="text" id="pname" name="from" placeholder="Party name..">
      </span>
    </span>
      
      <span class="row" style="margin-left:0px; width:500px;">
      <span class="col-25" style="width:50px;">
        <label for="pname" style="margin:0px; margin-left: 65px;   width:50px; ">To:</label>
      </span>
      <span class="col-75" style="width:343px; ">
        <input style=" margin-left: 115px; width:239px; " type="text" id="pname" name="to" placeholder="Party name..">
      </span>
    </span>
    ...
    <div class="row">
      ...
      <div class="row">
      <div class="col-25">
        <label for="transportdetail">Transport Detail</label>
      </div>
      <div class="col-75">
        <input type="text" id="transportdetail" name="transportdetail" placeholder="Transport Detail..">
      </div>
    </div>
      ...
      <br>
        <br>
        <button class="button-7"><b>Transfer</b></button>
