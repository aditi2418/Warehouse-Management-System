<%-- 
    Document   : warehouse-data
    Created on : 18 Oct, 2021, 2:37:38 AM
    Author     : 91934
--%>
...
<head>
        ...
        <!-- Title -->
        <title>Warehouse-Acron International</title>
         ...
         <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="warehouse.jsp" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-th"></span><p>Warehouse</p></a></li>
...
<!-- Page Sidebar -->
             <div class="page-inner">
                <div class="page-title" style="margin-bottom: 0px;">
                    ...
                    <div class="sortable">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel panel-white" style="background: #33333352;">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Grey</h3>
    ...
    <th>Material Name</th>
    <th style="padding-left: 71px;">Quantity</th>
  ...
  <tr>
      <%
       try
       {
           ...
           String query1="select * from items,dewas where color='grey' and dewas.Material_Name=items.Material_Name";
           ResultSet rs1=st.executeQuery(query1);
           while(rs1.next())
           {
           %>
    <td><%out.println(rs1.getString("items.Material_Name"));%></td>
    <td style="padding-left: 71px;"><%out.println(rs1.getFloat("dewas.Quantity"));%></td>
   ...
   <% } %>
                                        ...
                                        <div class="panel panel-white" style="background: #f9f9f9;">
                                    <div class="panel-heading">
  ...
  <% String query5="select * from items,dewas where color='white' and dewas.Material_Name=items.Material_Name";
           ResultSet rs5=st.executeQuery(query5);
           while(rs5.next())
           {
           %>       
  <tr>
    <td><%out.println(rs5.getString("items.Material_Name"));%></td>
    <td style="padding-left: 71px;"><%out.println(rs5.getFloat("dewas.Quantity"));%></td>
  ...
  <% } %>
                                ...
                                <div class="panel panel-purple" style="background: #f25656;">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Dead Stock</h3>
                                        <div class="panel-control">
                                            <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Expand/Collapse" class="panel-collapse"><i class="icon-arrow-down"></i></a>
                                            <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Reload" class="panel-reload"><i class="icon-reload"></i></a>
   ...
   <% String query2="select * from items,dewas where color='dead' and dewas.Material_Name=items.Material_Name";
           ResultSet rs2=st.executeQuery(query2);
           while(rs2.next())
           {
           %>       
  <tr>
    <td><%out.println(rs2.getString("items.Material_Name"));%></td>
    <td style="padding-left: 71px;"><%out.println(rs2.getFloat("dewas.Quantity"));%></td>
  ...
  <% } %>
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-green" style="background: #337ab7;">
                                    <div class="panel-heading">
  ...
  <% String query3="select * from items,dewas where color='blue' and dewas.Material_Name=items.Material_Name";
           ResultSet rs3=st.executeQuery(query3);
           while(rs3.next())
           {
           %>       
  <tr>
    <td><%out.println(rs3.getString("items.Material_Name"));%></td>
    <td style="padding-left: 71px;"><%out.println(rs3.getFloat("dewas.Quantity"));%></td>
  ...
  <% } %>
                                ...
                                <div class="panel panel-red" style="background: #a94442;">
                                    <div class="panel-heading">
  ...
  <% String query4="select * from items,dewas where color='others' and dewas.Material_Name=items.Material_Name";
           ResultSet rs4=st.executeQuery(query4);
           while(rs4.next())
           {
           %>       
  <tr>
    <td><%out.println(rs4.getString("items.Material_Name"));%></td>
    <td style="padding-left: 71px;"><%out.println(rs4.getFloat("dewas.Quantity"));%></td>
  ...
  <% } %>
                            ...
                            <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                <div class="panel panel-green"style="background: #edb925;">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Off Grade</h3>
                                        <div class="panel-control">
                                            <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Expand/Collapse" class="panel-collapse"><i class="icon-arrow-down"></i></a>
                                            <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Reload" class="panel-reload"><i class="icon-reload"></i></a>
                                      </div>
  ...
  <% String query6="select * from items,dewas where color='resin' and dewas.Material_Name=items.Material_Name";
           ResultSet rs6=st.executeQuery(query6);
           while(rs6.next())
           {
           %>       
  <tr>
    <td><%out.println(rs6.getString("items.Material_Name"));%></td>
    <td style="padding-left: 71px;"><%out.println(rs6.getFloat("dewas.Quantity"));%></td>
...
System.out.println(e);
        ...
        %>
                                            <tr>
                                                <td><%out.println(rs.getString("warehouse_id"));%></td>
                                                <td><%out.println(rs.getString("warehouse_name"));%></td>
