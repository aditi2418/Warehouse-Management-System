<%-- 
    Document   : party-data
    Created on : 3 Nov, 2021, 12:52:01 AM
    Author     : 91934
--%>
         ...
         <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="party-data.jsp" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-th-large"></span><p>Party</p></a></li>
...
<!-- Page Sidebar -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-white" >
                                <div class="panel-heading">
                                    <h4 class="panel-title">All Parties</h4>
                                </div>
                                <div class="panel-body">
                                    <button type="button" class="btn btn-success m-b-sm" data-toggle="modal" data-target="#myModal">Add Party</button>
                                    <!-- Modal -->
                                                     <!-- Modal -->
                                                    <form id="add-row-form" action="AddPartyServlet" method="Post">
                                    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                    <h4 class="modal-title" id="myModalLabel" style="font-weight: 800; font-size:1.5em; text-decoration: underline; ">Add Party</h4>                                                </div>
                                                <div class="modal-body" style="margin-top: 3%;">
                                                    
                                                        
                                                    
                                                        <div class="form-group">
                                                            <input type="text" name="party" id="name-input" class="form-control" placeholder="New Party Name" required>
                                                        </div>
        ...
        %>
                                            <tr>
                                                <td><%out.println(rs.getString("Party_ID"));%></td>
