...
$(document).ready(function() {
    ...
    <div class="overlay"></div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <!-- Modal -->
                                                    <form id="add-row-form" action="SaleCheckerServlet" method="Post">
        ...
        try
        {
         ...
         String query="select * from sale where warehouse='dewas';";
         ResultSet rs=st.executeQuery(query);
         while(rs.next())
         {
        %>
                                            <tr>
                                                ...
                                                %></td>
                                                <td><a href='add-document.jsp?id=<%out.println(rs.getInt("sale_id"));%>&mode=sale'><button ><big style="font-size:12px;">+ Add Document</big> 
                                                            <span class="glyphicon glyphicon-file"></span></button></a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-sm btn-default" title="Edit" href="Updatesale.jsp?sale_id=<%out.println(rs.getInt("sale_id"));%>">
                                                      <i class="glyphicon glyphicon-pencil"></i>
                                                    </a>

                                                    <a class="btn btn-sm btn-default" title="Delete" onclick="return yes_js_login();" href="SaleDeleteServlet?saleid=<%out.print(rs.getInt("sale_id"));%>&quantity=<%out.print(rs.getString("quantity"));%>&material=<%out.println(rs.getString("material_name"));%>&warehouse=<%out.println(rs.getString("warehouse"));%>">
