...
<!-- Page Sidebar -->
        ...
        %>
                                            <tr>
                                                ...
                                                <td><a href='add-document.jsp?id=<%out.println(rs.getString("import_id"));%>&mode=import'><button ><big style="font-size:12px;">+ Add Document</big> <span class="glyphicon glyphicon-file"></span></button></a>
                                                </td>
                                                <td name="buttons" ><div class="btn-group pull-right"><button id="bEdit" type="button" class="btn btn-sm btn-default" data-toggle="modal" data-target="#myModal1"><span class="glyphicon glyphicon-pencil"> </span></button><a  href="DeleteImportServlet?importid=<%out.print(rs.getInt("import_id"));%>&quantity=<%out.print(rs.getFloat("quantity"));%>&material=<%out.println(rs.getString("material_name"));%>&warehouse=<%out.println(rs.getString("warehouse_name"));%>"><button id="bElim" type="button" class="btn btn-sm btn-default" onclick="rowElim(this);"><span class="glyphicon glyphicon-trash"> </span></button></a><button id="bAcep" type="button" class="btn btn-sm btn-default" style="display:none;" onclick="rowAcep(this);"><span class="glyphicon glyphicon-ok"> </span></button><button id="bCanc" type="button" class="btn btn-sm btn-default" style="display:none;" onclick="rowCancel(this);"><span class="glyphicon glyphicon-remove"> </span></button></div></td>
                                            </tr> 
                                            <%
        }
       }
