            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="sale.jsp" class="waves-effect waves-button"><span ><i class="fa fa-briefcase" style="font-size:27px"></i></span><p>Sale</p></a></li>
                        <li><a href="transfer.jsp" class="waves-effect waves-button"><span ><i class="fa fa-truck" style="font-size:29px;"></i></span><p>Transfer</p></a></li>
                     ...
                     <li><a href="transaction.html" class="waves-effect waves-button"><span ><i class="fa fa-exchange fa-2x" aria-hidden="true"></i></span><p>Transaction</p></a></li>
                        <li><a href="item.jsp" class="waves-effect waves-button"><span ><i class="fa fa-reorder" style="font-size:29px"></i></span><p>Item</p></a></li>
