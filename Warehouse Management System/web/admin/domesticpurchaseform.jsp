...
input,select,textarea{
    ...
    <center>
        <form action="DomesticCheckerServlet" method="post" enctype='multipart/form-data' >
            
         
      <input type="date" name="date" placeholder="date">
        <input type="text" name="warehouse" placeholder="warehouse name">
        <input type="text" name="party" placeholder="party name">
        <input type="text" name="quantity" placeholder="quantity">
        <input type="text" name="material" placeholder="material name">
        <input type="text" name="payment" placeholder="payment status">
         <input type="text" name="referpoint" placeholder="refer point name">
        <input type="text" name="rate" placeholder="rate">
        <input type="text" name="agent" placeholder="agent">
        <input type="text" name="termsofdelivery" placeholder="terms of delivery" >
        <input type="text" name="vehiclenumber" placeholder="vehiclenumber">
        <input type="text" name="drivername" placeholder="drivername">
        <input type="text" name="drivercontact" placeholder="drivercontact">
        <input type="text" name="transportname" placeholder="transportname">
        <input type="text" name="transportdetails" placeholder="transportdetails">
        <input type="text" name="soldby" placeholder="soldby">
...
<div class="file-loading" > 
    ...
    <input id="input-b6a1" name="input-b6a1[]" type="file" multiple >
      ...
      <div class="row">
      <div class="col-25">
        <label for="ewaybill">Weight Slip</label>
      </div>
        <div class="col-75">
