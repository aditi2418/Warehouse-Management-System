...
<head>
        ...
        <!-- Title -->
        <title>Transaction-Acron International</title>
          ...
          <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                     ...
                     <li class="active"><a href="table-data.jsp" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-sort"></span><p>Transaction</p></a></li>
...
<!-- Page Sidebar -->
        ...
        %>
                                            <tr>
                                                ...
                                                <td><%out.println(rs.getString("transaction_id"));%></td>
                                                ...
                                                <td><%
                                                        if(rs.getString("Mode").equals("sale"))
                                                        {
                                                           %>
                                                           <span style=" font-size: 1.0em;" class="label label-info"><%out.println(rs.getString("Mode"));%></span>
                                                           <%
                                                        }
                                                        else
                                                        {
                                                            if(rs.getString("Mode").equals("transfer"))
                                                            {
                                                                %>
                                                                    <span style=" font-size: 1.0em;" class="label label-danger"><%out.println(rs.getString("Mode"));%></span>
                                                                <%
                                                            }
                                                            else
                                                            {
                                                                %>
                                                                    <span style=" font-size: 1.0em;" class="label label-primary"><%out.println(rs.getString("Mode"));%></span>
                                                                <%
                                                            }   
                                                        }
