...
<!-- Page Sidebar -->
                                                ...
                                                <div class="modal-body" style="margin-top: 3%;">
                                                    ...
                                                    <select id="material-input" name="material" class="form-control" placeholder="Material Name" style="color: #a4a4a4" required>
                                                                ...
                                                                try
                                                            {
                                                             ...
                                                             while(rs1.next())
                                                             { %>
                                                              <option value="<%out.print(rs1.getString("Material_Name"));%>"><%out.print(rs1.getString("Material_Name"));%></option>
                                                              <%
                                                               }
                                                            }
                                                               catch(SQLException e)
        ...
        %>
                                            <tr>
                                                ...
                                                <td><%out.println(rs.getString("from"));%></td>
