...
$(document).ready(function() {
    ...
    <div class="overlay"></div>
        ...
        <main class="page-content content-wrap">
         ...
         <%
        String import_id=request.getParameter("id");
        String pn="";
        String sb="";
        String payment="";
        %>
                                    <form action="NewEditServlet_1" method="Post">
                                        <div class="form-group">
                                            <label for="importid">Import ID</label><br>
                                            <input type="text" value="<%out.print(import_id);%>" name="importid" class="form-control" id="importid" hidden>
                                        </div>
                                        <div class="form-group">
