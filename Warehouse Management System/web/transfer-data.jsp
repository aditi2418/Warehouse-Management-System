...
<head>
      <link rel="icon" href="icon5.png">    <!-- Title -->
...
<!-- Page Sidebar -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <button type="button" class="btn btn-success m-b-sm" data-toggle="modal" data-target="#myModal">New Transfer</button>
                                    <!-- Modal -->
                                                    <form id="add-row-form" action="TransferCheckerServlet" method="Post">
                                    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                    <h4 class="modal-title" id="myModalLabel" style="font-weight: 800; font-size:1.5em; text-decoration: underline; ">New Transfer</h4>                                                </div>
                                                <div class="modal-body" style="margin-top: 3%;">
                                                    ...
                                                    <select id="material-input" name="from" class="form-control" placeholder="Material Name" style="color: #a4a4a4" required>
                                                    ...
                                                    <select id="material-input" name="to" class="form-control" placeholder="Material Name" style="color: #a4a4a4" required>
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <input type="text" list="materialinput" class="form-control" name="material" placeholder="Material Name"> 
                                                                  
                                                            <datalist id="materialinput">
                                                            <% 
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" style="text-transform:uppercase" onchange="this.value = this.value.toUpperCase(); pr()" name="vehiclenumber" id="vehicle-number-input" class="form-control" placeholder="Vehicle Number">
                                                        </div>
                                                            
                                                        <div class="form-group">
                                                            <input type="text" name="drivername" id="driver-name-input" class="form-control" placeholder="Driver Name" >
                                                        </div>    
                                                         
                                                        <div class="form-group">
                                                            <input type="text" name="drivercontact" id="driver-contact-input" class="form-control" placeholder="Driver Contact">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <input type="text" name="transportname" id="transport-name-input" class="form-control" placeholder="Transport Name" >
                                                        </div>
                                                            
                                                        <div class="form-group">
                                                            <input type="text" name="transportdetails" id="transport-details-input" class="form-control" placeholder="Transport Details">
                                                        </div>    
                                                        
                                                        <div class="form-group">
                                                            <input type="text" name="termsofdelivery" id="terms-of-delivery-input" class="form-control" placeholder="Terms Of Delivery" >
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <input type="text" name="rate" id="rate-input" class="form-control" placeholder="Rate">
                                                        </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit"  class="btn btn-success">Transfer</button>
                                                            ...
                                                            <!-- Modal  -->
                                                    <form id="add-row-form1" action="UpdateTransferServlet" method="Post">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="margin-top: 3%;">
                                                    ...
                                                    <div class="form-group">
                                                            <select id="sale-id-input" name="transferid" class="form-control" placeholder="Sale ID" style="color: #a4a4a4" required>
                                                                <option value="">Transfer ID</option>
                                                            <% 
                                                                ...
                                                                try
                                                            {
                                                             ...
                                                             while(rs.next())
                                                             { %>
                                                              <option value="<%out.print(rs.getInt("transfer_id"));%>"><%out.print(rs.getInt("transfer_id"));%></option>
                                                              <%
                                                               }
                                                            }
                                                               catch(SQLException e)
        ...
        try
        {
         ...
         String query="select * from transfer where (from1='dewas')";
         ResultSet rs=st.executeQuery(query);
         while(rs.next())
         {
        %>
                                            <tr>
                                                ...
                                                <td><%out.println(rs.getInt("transfer_id"));%></td>
                                                <td><%out.println(rs.getString("from1"));%></td>
                                                ...
                                                %></td>
                                        <td><%out.println(rs.getString("to"));%></td>
                                                <td><a href='add-document.jsp?id=<%out.println(rs.getString("transfer_id"));%>&mode=transfer'><button ><big style="font-size:12px;">+ Add Document</big> <span class="glyphicon glyphicon-file"></span></button></a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-sm btn-default" title="Edit" href="Updatetransfer.jsp?id=<%out.println(rs.getString("transfer_id"));%>">
                                                      <i class="glyphicon glyphicon-pencil"></i>
                                                    </a>

                                                    <a class="btn btn-sm btn-default" title="Delete" onclick="return yes_js_login();" href="TransferDeleteServlet?transferid=<%out.print(rs.getInt("transfer_id"));%>&quantity=<%out.print(rs.getString("quantity"));%>&material=<%out.println(rs.getString("material_name"));%>&from=<%out.println(rs.getString("from1"));%>&to=<%out.println(rs.getString("to"));%>">
