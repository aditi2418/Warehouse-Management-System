...
<head>
        ...
        <!-- Title -->
        <title>Domestic-Acron International</title>
                        ...
                        <li><a href="transfer-data.jsp" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-send"></span><p>Transfer</p></a></li>
                         ...
                         <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-shopping-cart"></span><p>Purchase</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="domestic-data.jsp">Domestic</a></li>
...
<!-- Page Sidebar -->
             <div class="page-inner">
                <div class="page-title" style="margin-bottom: 0px;">
                    <h3><b>Domestic Purchase</b></h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="home.jsp">Home</a></li>
                            <li class="active">Purchase</li>
                            <li class="active">Domestic Purchase</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                   <button type="button" class="btn btn-success m-b-sm"data-toggle="modal" data-target="#myModal" >New Purchase</button>
                                    <!-- Modal -->
                                                    <form id="add-row-form" action="DomesticCheckerServlet" method="Post">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="margin-top: 3%;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" style="text-transform:uppercase" onchange="this.value = this.value.toUpperCase(); pr()" name="vehiclenumber" id="vehicle-number-input" class="form-control" placeholder="Vehicle Number" required>
                                                        </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit"  class="btn btn-success">Submit</button>
                                                             ...
                                                             <!-- Modal  -->
                                                    <form id="add-row-form1" action="UpdateDomesticServlet" method="Post">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="margin-top: 3%;">
                                                    ...
                                                    <div class="form-group">
                                                            <select id="sale-id-input" name="domesticid" class="form-control" placeholder="Domestic ID" style="color: #a4a4a4" required>
                                                                <option value="">Domestic ID</option>
                                                            <% 
                                                                ...
                                                                try
                                                            {
                                                             ...
                                                             while(rs.next())
                                                             { %>
                                                              <option value="<%out.print(rs.getInt("domestic_id"));%>"><%out.print(rs.getInt("domestic_id"));%></option>
                                                              <%
                                                               }
                                                            }
                                                               catch(SQLException e)
        ...
        try
        {
         ...
         String query="select * from domestic where warehouse='dewas';";
         ResultSet rs=st.executeQuery(query);
         while(rs.next())
         {
        %>
                                            <tr>
                                                ...
                                                <td><%out.println(rs.getInt("domestic_id"));%></td>
                                               ...
                                               <%String tok=rs.getString("Material_Name");
                                                ...
                                                <td><a href='add-document.jsp?id=<%out.println(rs.getString("domestic_id"));%>&mode=domestic'><button ><big style="font-size:12px;">+ Add Document</big> <span class="glyphicon glyphicon-file"></span></button></a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-sm btn-default" title="Edit" href="Updatedomestic.jsp?id=<%out.println(rs.getString("domestic_id"));%>">
                                                      <i class="glyphicon glyphicon-pencil"></i>
                                                    </a>

                                                    <a class="btn btn-sm btn-default" title="Delete" onclick="return yes_js_login();" href="DomesticDeleteServlet?domesticid=<%out.print(rs.getInt("domestic_id"));%>&quantity=<%out.print(rs.getString("quantity"));%>&material=<%out.print(rs.getString("material_name"));%>&warehouse=<%out.print(rs.getString("warehouse"));%>">
