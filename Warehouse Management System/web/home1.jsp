...
try
        {
         ...
         String query="select * from sale where MONTH(date) = MONTH(now()) and YEAR(date) = YEAR(now());";
         ...
         String query1="select * from transfer where MONTH(date) = MONTH(now()) and YEAR(date) = YEAR(now());";
         ...
         String query2="select * from import where MONTH(date) = MONTH(now()) and YEAR(date) = YEAR(now());";
         ...
         String query3="select * from domestic where MONTH(date) = MONTH(now()) and YEAR(date) = YEAR(now());";
         ...
         String query4="select * from transactions where MONTH(Date) = MONTH(now()) and YEAR(Date) = YEAR(now());";
