...
try
        {
         ...
         String query="select * from sale where MONTH(date) = MONTH(now()) and YEAR(date) = YEAR(now())  and warehouse='dewas';";
         System.out.println("Hehe Query : "+query);
         ResultSet rs1=st.executeQuery(query);
         float salevalue = 0;
         String svalue="";
         ArrayList<String> arsl=new ArrayList<String>();
         ArrayList<String> artl=new ArrayList<String>();
         ArrayList<String> aril=new ArrayList<String>();
         ArrayList<String> ardl=new ArrayList<String>();
         ArrayList<String> artrl=new ArrayList<String>();
         //ArrayList<Float> frl=new ArrayList<Float>();
         float tempsalesum = 0.0f;
         float temptransfersum = 0.0f;
         float tempimportsum = 0.0f;
         float tempdomesticsum = 0.0f;
         float temptransactionsum = 0.0f;
         
         while(rs1.next())
         {
            arsl.add(rs1.getString("quantity"));
         }
         ...
         for(String a : arsl)
         {
            ...
            {
                tempsalesum = tempsalesum + Float.parseFloat(stk.nextToken());
         ...
         System.out.println("hello"+tempsalesum);
         
         
         String query1="select * from transfer where MONTH(date) = MONTH(now()) and YEAR(date) = YEAR(now())  and from1='dewas';";
         ResultSet rs2=st.executeQuery(query1);
         float salevalue1 = 0;
         
         while(rs2.next())
         {
            artl.add(rs2.getString("Quantity"));
         }
         for(String a : artl)
         {
         ...
         for(String a : artl)
         {
             ...
             while(stk.hasMoreTokens())
            {
                temptransfersum =temptransfersum + Float.parseFloat(stk.nextToken());
                
            }
           
         }
         System.out.println("TempTransferSum : "+temptransfersum);
         
         String query2="select * from import where MONTH(date) = MONTH(now()) and YEAR(date) = YEAR(now())  and warehouse_name='dewas';";
         ResultSet rs3=st.executeQuery(query2);
         float salevalue2 = 0;
         
         while(rs3.next())
         {
            aril.add(rs3.getString("Quantity"));
         }
         for(String a : aril)
         {
             System.out.println("The String Is : "+a);
         ...
         for(String a : aril)
         {
             ...
             while(stk.hasMoreTokens())
            {
                tempimportsum =tempimportsum + Float.parseFloat(stk.nextToken());
                
            }
           
         }
         System.out.println("TempImportSum : "+tempimportsum);
         
         
         
         String query3="select * from domestic where MONTH(date) = MONTH(now()) and YEAR(date) = YEAR(now())  and warehouse='dewas';";
         ResultSet rs4=st.executeQuery(query3);
         float salevalue3 = 0;
         
         while(rs4.next())
         {
            ardl.add(rs4.getString("quantity"));
         }
         for(String a : ardl)
         {
             System.out.println("The String Is : "+a);
         ...
         for(String a : ardl)
         {
             ...
             while(stk.hasMoreTokens())
            {
                tempdomesticsum =tempdomesticsum + Float.parseFloat(stk.nextToken());
                
            }
           
         }
         System.out.println("TempDomesticSum : "+tempdomesticsum);
         
         
         String query4="select * from transactions where MONTH(Date) = MONTH(now()) and YEAR(date) = YEAR(now())  and Warehouse='dewas';";
         ResultSet rs5=st.executeQuery(query4);
         float salevalue4 = 0;
         
         while(rs5.next())
         {
            artrl.add(rs5.getString("Quantity"));
         }
         for(String a : artrl)
         {
             System.out.println("The String Is : "+a);
         ...
         for(String a : artrl)
         {
             ...
             while(stk.hasMoreTokens())
            {
                temptransactionsum =temptransactionsum + Float.parseFloat(stk.nextToken());
                
            }
           
         }
         System.out.println("TempTransactionSum : "+temptransactionsum);
         
         salevalue = tempsalesum;
         salevalue1 = temptransfersum;
         salevalue2 = tempimportsum;
         salevalue3 = tempdomesticsum;
         salevalue4 = temptransactionsum;
         ...
         //select * from items,dewas where color='grey' and dewas.Material_Name=items.Material_Name

         //Bar Graph Backend Hehe
         String querya1="select count(*),sum(Quantity) from items,dewas where color='white' and dewas.Material_Name=items.Material_Name";
        ...
        String queryb2="select count(*),sum(Quantity) from items,dewas where color='blue' and dewas.Material_Name=items.Material_Name";
         ...
         String queryc3="select count(*),sum(Quantity) from items,dewas where color='grey' and dewas.Material_Name=items.Material_Name";
         ...
         String queryd4="select count(*),sum(Quantity) from items,dewas where color='resin' and dewas.Material_Name=items.Material_Name";
         ...
         String querye5="select count(*),sum(Quantity) from items,dewas where color='dead' and dewas.Material_Name=items.Material_Name";
         ...
         String queryf6="select count(*),sum(Quantity) from items,dewas where color='others' and dewas.Material_Name=items.Material_Name";
         ...
         String queryg7="select count(*),sum(Quantity) from dewas";
...
<%
        ...
        try
        {
         ...
         String queryo="select * from warehouse where warehouse_name='dewas';";
...
try
        {
         ...
         String querya="select count(*),sum(Quantity) from items,dewas where color='white' and dewas.Material_Name=items.Material_Name";
        ...
        String queryb="select count(*),sum(Quantity) from items,dewas where color='blue' and dewas.Material_Name=items.Material_Name";
         ...
         String queryc="select count(*),sum(Quantity) from items,dewas where color='grey' and dewas.Material_Name=items.Material_Name";
         ...
         String queryd="select count(*),sum(Quantity) from items,dewas where color='resin' and dewas.Material_Name=items.Material_Name";
         ...
         String querye="select count(*),sum(Quantity) from items,dewas where color='dead' and dewas.Material_Name=items.Material_Name";
         ...
         String queryf="select count(*),sum(Quantity) from items,dewas where color='others' and dewas.Material_Name=items.Material_Name";
         ...
         String queryg="select count(*),sum(Quantity) from dewas";
                                       ...
                                       <table class="table">
                                           ...
                                           <tbody>
                                               ...
                                               <tr>
                                                   ...
                                                   <td>
                                                       <div class="progress progress-sm">
                                                           <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: <%out.print(perf);%>%">
                                                           </div>
                                                       </div>
                                                   </td>
                                               </tr>
